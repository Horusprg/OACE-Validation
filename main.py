...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader, classes = get_wildshapes_dataloaders(batch_size=32, num_workers=2)
    ...
    optimizer = AFSAGAPSO(
        ...
        afsa_params={'visual': 40, 'step': 5, 'try_times': 1, 'max_iter': 2},
        pso_params={"c1": 1.5, "c2": 1.5, "w": 0.7, "k": 3, "p": 2},
        ga_params={"initial_crossover_rate": 0.7, "initial_mutation_rate": 0.30, "tournament_size": 3, "max_iter": 3},
