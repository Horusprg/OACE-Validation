...
class AFSAGAPSO:
    ...
    def _generate_initial_candidates(
        ...
        candidates = afsa.optimize(logger=self.logger)
    ...
    def _execute_ga_pso_phase(self, phase1_solutions):
        ...
        best_position, best_fitness = self.ga.optimize(logger=self.logger)
...
if __name__ == "__main__":
    ...
    optimizer = AFSAGAPSO(
        ...
        architectures_to_optimize=['CNN']  # ['CNN', 'ResNet', 'EfficientNet', 'MobileNet']
    )
